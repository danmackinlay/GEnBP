...
sweep_values = np.geomspace(1e-4, 1e2, num=25, endpoint=True)  # Exponential sweep for 'a'
...
(
    gbp_experiment,
    genbp_experiment, laplace_experiment,
    langevin
) = exps
(
    gbp_experiment_name,
...
for i, ax in enumerate(axs):
    ...
    # ax.text(
    #     0.05, 0.05, title, transform=ax.tran
    # sAxes, fontsize=10, va='bottom', ha='left',
    #     bbox=dict(
